...
trained_denoise_model_dir = f"./trained-model-myHDR_detail_only_conv333_new-final_nosat_conv"
trained_denoise_model_filename = 'trained_model900.pkl'
...
start = time.time()
loss = testing_gate(model, denoise_model, loss_func, gate_func, testimage_dataset, outdir, args)
end = time.time()
